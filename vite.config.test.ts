...
describe("Needo production chunks", () => {
  it("keeps feature translations outside the base i18n budget", () => {
    ...
    expect(resolveNeedoManualChunk("/workspace/src/features/field-jobs/i18n.ts"))
      .toBe("field-jobs-i18n");
    expect(resolveNeedoManualChunk("/workspace/src/features/auth/i18n.ts"))
      .toBe("auth-i18n");
