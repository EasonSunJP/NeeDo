...
- [x] **Step 3: Add validation and service contracts**
...
- [x] **Step 4: Implement employee routes with derived scope**
...
- [x] **Step 5: Add repository tests and OpenAPI coverage**
...
- [x] **Step 1: Write failing adapter and panel tests**
...
- [x] **Step 4: Implement the controlled compensation panel**
...
- [x] **Step 5: Mount the panel in the employee card**
...
- [x] **Step 7: Commit the frontend panel**
...
- [x] **Step 3: Implement race-safe orchestration**
...
- [x] **Step 4: Complete user-visible localization and docs**
...
- [x] **Step 8: Commit the integration and documentation**
