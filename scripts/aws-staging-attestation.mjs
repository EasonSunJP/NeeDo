...
const bootstrapScript = [
  ...
  `  gpg --homedir "$cloudwatch_agent_gnupg_home" --batch ${gpgKeyLoadOption} "$cloudwatch_agent_tmpdir/amazon-cloudwatch-agent.gpg" >/dev/null`,
  "  gpg --homedir \"$cloudwatch_agent_gnupg_home\" --batch --verify \\",
