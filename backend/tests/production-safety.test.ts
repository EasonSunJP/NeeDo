...
describe("production safety", () => {
  ...
  it.each([
    ...
    ["placeholder Google client ID", { GOOGLE_AUTH_CLIENT_ID: "replace-with-prod-google-client-id" }, "GOOGLE_AUTH_CLIENT_ID"],
    ["test Google client ID", { GOOGLE_AUTH_CLIENT_ID: "test-google-client-id.apps.googleusercontent.com" }, "GOOGLE_AUTH_CLIENT_ID"],
    ["local Google client ID", { GOOGLE_AUTH_CLIENT_ID: "123456789012-local-google-client.apps.googleusercontent.com" }, "GOOGLE_AUTH_CLIENT_ID"],
    ["dummy Google client ID", { GOOGLE_AUTH_CLIENT_ID: "123456789012-dummy-google-client.apps.googleusercontent.com" }, "GOOGLE_AUTH_CLIENT_ID"],
    ["malformed Google client ID domain", { GOOGLE_AUTH_CLIENT_ID: "123456789012-google-client.example.com" }, "GOOGLE_AUTH_CLIENT_ID"],
