...
describe("Exchange matched-result booking conversion contracts", () => {
  ...
  it("reserves stable booking conversion errors and owner-only booking permission", () => {
    expect(ERROR_CODES).toMatchObject({
      ...
      EXCHANGE_MATCH_BOOKING_NOT_FOUND: 40429,
      EXCHANGE_MATCH_BOOKING_INVALID_STATE: 41009,
      EXCHANGE_MATCH_BOOKING_VERSION_CONFLICT: 41010,
      EXCHANGE_MATCH_BOOKING_ALREADY_CREATED: 41011,
      EXCHANGE_MATCH_BOOKING_SLOT_UNAVAILABLE: 41012,
      EXCHANGE_MATCH_BOOKING_IDEMPOTENCY_CONFLICT: 41013,
      EXCHANGE_MATCH_CANCELLATION_REQUIRED: 41014
    });
