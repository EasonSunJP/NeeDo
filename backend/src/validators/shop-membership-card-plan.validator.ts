...
const validitySchema = z.discriminatedUnion("mode", [
  ...
  z.object({ mode: z.literal("fixed_date"), expiresAt: z.string().datetime().transform((value) => new Date(value)) }).strict()
]);
...
export const shopMembershipCardPlanDraftBodySchema = z.object({
...
export const shopMembershipCardPlanPreviewBodySchema = z.object({
...
}).strict().transform(({ scheduledAt, ...input }) => ({ ...input, occurredAt: scheduledAt }));
...
export const membershipRewardFeePolicyCreateBodySchema = z.object({
...
export type ShopMembershipCardPlanDraftBody = z.output<typeof shopMembershipCardPlanDraftBodySchema>;
export type ShopMembershipCardPlanPreviewBody = z.output<typeof shopMembershipCardPlanPreviewBodySchema>;
export type ShopMembershipCardPlanPublishBody = z.output<typeof shopMembershipCardPlanPublishBodySchema>;
export type MembershipRewardFeePolicyCreateBody = z.output<typeof membershipRewardFeePolicyCreateBodySchema>;
