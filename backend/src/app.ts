...
import { createTechnicianAutomationRoutes } from "./routes/technician-automation.routes";
import { createCalendarEventRoutes } from "./routes/calendar-event.routes";
...
import type { TechnicianAutomationRepositoryPort, TechnicianAutomationService } from "./services/technician-automation.service";
import type { CalendarEventRepositoryPort } from "./repositories/calendar-event.repository";
...
export const createApp = (
  ...
  mount("shared", createTechnicianAutomationRoutes(config, resolvedDependencies));
  mount("shared", createCalendarEventRoutes(config, resolvedDependencies));
