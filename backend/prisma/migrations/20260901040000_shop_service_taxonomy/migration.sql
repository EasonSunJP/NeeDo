...
ALTER TABLE `shop_service_categories` ADD CONSTRAINT `shop_service_categories_shop_id_fkey` FOREIGN KEY (`shop_id`) REFERENCES `shops`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE `shop_service_categories` ADD CONSTRAINT `shop_service_categories_category_id_fkey` FOREIGN KEY (`category_id`) REFERENCES `categories`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE `shop_business_keywords` ADD CONSTRAINT `shop_business_keywords_shop_id_fkey` FOREIGN KEY (`shop_id`) REFERENCES `shops`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE `shop_business_keywords` ADD CONSTRAINT `shop_business_keywords_business_keyword_id_fkey` FOREIGN KEY (`business_keyword_id`) REFERENCES `business_keywords`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE `shop_service_qualifications` ADD CONSTRAINT `shop_service_qualifications_category_id_fkey` FOREIGN KEY (`category_id`) REFERENCES `categories`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE `shop_service_qualifications` ADD CONSTRAINT `shop_service_qualifications_business_keyword_id_fkey` FOREIGN KEY (`business_keyword_id`) REFERENCES `business_keywords`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE `merchant_application_service_categories` ADD CONSTRAINT `merchant_application_service_categories_application_id_fkey` FOREIGN KEY (`application_id`) REFERENCES `identity_applications`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE `merchant_application_service_categories` ADD CONSTRAINT `merchant_application_service_categories_category_id_fkey` FOREIGN KEY (`category_id`) REFERENCES `categories`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE `merchant_application_business_keywords` ADD CONSTRAINT `merchant_application_business_keywords_application_id_fkey` FOREIGN KEY (`application_id`) REFERENCES `identity_applications`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE `merchant_application_business_keywords` ADD CONSTRAINT `merchant_application_business_keywords_business_keyword_id_fkey` FOREIGN KEY (`business_keyword_id`) REFERENCES `business_keywords`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
