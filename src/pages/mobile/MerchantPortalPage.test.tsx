...
describe("MerchantPortalPage store privacy control", () => {
  ...
  it("adds the floating privacy menu to the merchant service card only", () => {
    ...
    expect(merchantSource).toContain("pricingModeApi.updateShopVisibility(storeApiId, visibility)");
    expect(merchantSource).not.toContain("merchantProfileApi.getMine()");
    expect(merchantSource).not.toContain("merchantProfileApi.updateMine({ visibility })");
    ...
    expect(merchantSource).toContain("result.shopId !== storeApiId");
