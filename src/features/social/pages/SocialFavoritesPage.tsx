...
const favoritesCopy: Record<Language, {
  ...
  ja: { count: (value) => `お気に入り投稿 ${value}件`, description: "投稿のブックマークを押すとここに保存され、解除すると一覧からも削除されます。", emptyTitle: "お気に入りの投稿はまだありません", explore: "投稿を見る", chatRecords: "チャット履歴", title: "お気に入り" },
