...
it("requires manual confirmation and a note before approval, then sends snapshot version", async () => {
  ...
  const application: EkycApplicationDetail = { id: 7, userId: 41, status: "submitted", version: 3, createdAt: "2026-09-07T00:00:00Z", updatedAt: "2026-09-07T00:00:00Z", reviewedAt: null, rejectionReason: null, reviewNote: null, profile: { ...emptyEkycProfile, familyName: "山田", givenName: "太郎" } };
