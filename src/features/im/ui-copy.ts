...
const imUiTranslations: Record<string, ImUiTranslation> = {
  ...
  "当前内容无需翻译": { "zh-Hant": "目前內容無需翻譯", ja: "この内容は翻訳する必要がありません", en: "This content doesn't need translation", ko: "이 콘텐츠는 번역할 필요가 없습니다" },
  "此消息不支持翻译": { "zh-Hant": "此訊息不支援翻譯", ja: "このメッセージは翻訳できません", en: "This message can't be translated", ko: "이 메시지는 번역할 수 없습니다" },
  "所选信息包含暂不支持转发或收藏的类型": { "zh-Hant": "所選訊息包含目前無法轉發或收藏的類型", ja: "選択したメッセージに転送またはお気に入り登録できない形式が含まれています", en: "Some selected messages can't be forwarded or favorited", ko: "선택한 메시지에 전달하거나 즐겨찾기할 수 없는 형식이 포함되어 있습니다" },
