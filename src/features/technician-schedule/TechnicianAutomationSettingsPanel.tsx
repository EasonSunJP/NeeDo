    ...
    <div className="space-y-4 pb-[calc(104px+env(safe-area-inset-bottom))]" data-testid={`technician-${kind}-automation-settings`}>
      ...
      <section className={panelClass}>
        ...
        <div className="mt-3 space-y-4">
          ...
          <MultiChoice label="支付方式" options={[{ value: "onsite", label: "现金" }, { value: "card", label: "银行卡" }, { value: "ndp", label: "NDP" }, { value: "bank_transfer", label: "银行转账（历史订单）" }, { value: "other", label: "其他" }]} value={rules.paymentMethods} onChange={(paymentMethods) => updateRules({ paymentMethods })} />
