...
const copy: Record<Language, Record<MessageKey, string>> = {
  zh: {
    ...
    accountWalletUnavailable: "无法确认账户或 NDP 钱包，请重新登录后重试",
  ...
  "zh-Hant": {
    ...
    accountWalletUnavailable: "無法確認帳戶或 NDP 錢包，請重新登入後再試",
  ...
  ja: {
    ...
    accountWalletUnavailable: "アカウントまたはNDPウォレットを確認できません。再ログインしてください",
  ...
  en: {
    ...
    accountWalletUnavailable: "Cannot verify the account or NDP wallet. Sign in again and retry",
  ...
  ko: {
    ...
    accountWalletUnavailable: "계정 또는 NDP 지갑을 확인할 수 없습니다. 다시 로그인해 주세요",
