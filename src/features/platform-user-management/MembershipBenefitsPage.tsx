...
import { platformUserManagementText } from "./i18n";
import {
...
export function MembershipBenefitsPage() {
  ...
  return <AdminLayout><ModuleShell title="会员权益说明" description={platformUserManagementText("membershipBenefitsDescription", language)}>
