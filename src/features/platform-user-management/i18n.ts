...
const zh = {
  ...
  detailCard: "详细信息卡",
  simpleCard: "简易信息卡",
  detailSurfaceTopLeft: "详细卡底色・左上角",
  detailSurfaceMiddle: "详细卡底色・中段",
  detailSurfaceBottom: "详细卡底色・底部",
...
export const privacyScopeText = (scope: UserPrivacyScope, language: Language) =>
  directoryValueCopy[language].privacyScope[scope];
