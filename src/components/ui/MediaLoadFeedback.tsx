...
export function MediaLoadFeedback({ kind, expired = false, unavailable = false, className }: {
  ...
  return (
    <span className={cn("flex min-h-24 w-full flex-col items-center justify-center gap-2 px-3 py-4 text-center text-xs leading-5", className)} data-media-state={unavailable ? "unavailable" : expired ? "expired" : "failed"} data-no-i18n="true" role="status">
